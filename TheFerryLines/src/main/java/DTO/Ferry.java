...
public class Ferry implements Serializable{
    ...
    String name;
    char size;
    List<Client> passengerList;
    
    /**
     * S = small, M = medium, L = Large
     */

    public Ferry(UID ferryId, UID ferryLineId, String name, char size, List<Client> passengerList) {
    ...
    public void setPassengerList(List<Client> passengerList) {
        this.passengerList = passengerList;
    }
