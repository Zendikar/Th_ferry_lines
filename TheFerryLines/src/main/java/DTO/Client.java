...
public class Client implements Serializable{
    ...
    List<Reservation> routeTickets;

    public Client(UID personId, int municipalityCode, List<Reservation> routeTickets) {
    ...
    public List<Reservation> getRouteTickets() {
        return routeTickets;
    }

    public void setRouteTickets(List<Reservation> routeTickets) {
        this.routeTickets = routeTickets;
    }
